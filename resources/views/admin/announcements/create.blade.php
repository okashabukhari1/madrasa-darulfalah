...
<div class="db-card" style="max-width: 800px; margin: 0 auto;">
    <div class="db-card-header">
        ...
        <a href="{{ route('admin.announcements.index') }}" class="btn btn-outline btn-sm">Cancel</a>
    </div>
    ...
    <div class="db-card-body" style="padding: 2rem;">
        <form action="{{ route('admin.announcements.store') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <input type="text" name="title" value="{{ old('title') }}" style="width:100%; padding:0.75rem; border:1px solid var(--beige-dark); border-radius:8px; background:var(--white); font-family: 'Jameel Noori Nastaleeq', 'Noto Nastaliq Urdu', serif;">
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="expires_at" value="{{ old('expires_at') }}" style="width:100%; padding:0.75rem; border:1px solid var(--beige-dark); border-radius:8px; background:var(--white);">
                </div>
            </div>

            <div class="form-group" style="margin-bottom: 1.5rem;">
                <label style="display:block; margin-bottom:0.5rem; font-weight:600;">Content / Message*</label>
                <textarea name="content" rows="6" style="width:100%; padding:0.75rem; border:1px solid var(--beige-dark); border-radius:8px; background:var(--white); font-family: 'Jameel Noori Nastaleeq', 'Noto Nastaliq Urdu', serif;">{{ old('content') }}</textarea>
            </div>
            ...
            <div style="text-align: right;">
                <button type="submit" class="btn btn-gold" style="padding: 0.75rem 2.5rem;">Create Announcement</button>
            </div>
        </form>
    </div>
</div>
