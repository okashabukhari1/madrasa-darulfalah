...
@section('page_title', 'Latest Updates')
...
<div style="max-width:900px;">
    ...
    <div class="db-card" style="margin-bottom:1.5rem; {{ $loop->first ? 'border-left:4px solid var(--gold);' : '' }}">
        <div class="db-card-body" style="padding:2rem;">
            ...
            <a href="{{ route('student.announcements.show', $ann->id) }}"
    ...
    <div class="db-card">
        <div class="db-card-body" style="text-align:center; padding:5rem;">
            ...
            <p style="color:var(--text-light);">Check back later for news and updates from the Madrasa.</p>
        </div>
    </div>
    @endforelse
</div>
