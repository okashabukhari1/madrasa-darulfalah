...
const MdfData = {
  ...
  courses: [
    { id: 'CRS001', name: 'Hifz-ul-Quran',  teacher: 'Hafiz Usman Siddiqui', duration: '4-6 Years',  students: 145, status: 'active', category: 'Quran',   icon: '📖', seats: 160 },
    ...
    { id: 'CRS003', name: 'Alim Course',     teacher: 'Mufti Abdur Rauf',     duration: '8 Years',    students: 76,  status: 'active', category: 'Alim',    icon: '📚', seats: 80 },
    { id: 'CRS004', name: 'Arabic Language', teacher: 'Ustaz Ibrahim Al-Misri',duration: '2 Years',   students: 112, status: 'active', category: 'Arabic',  icon: '🌙', seats: 140 },
    ...
    { id: 'CRS006', name: 'Tafseer',         teacher: 'Maulana Saeed Ahmad',  duration: '3 Years',    students: 54,  status: 'active', category: 'Quran',   icon: '📜', seats: 60 },
    { id: 'CRS007', name: 'Hadith Sciences', teacher: 'Mufti Abdur Rauf',     duration: '4 Years',    students: 43,  status: 'active', category: 'Alim',    icon: '🕌', seats: 50 },
  ...
  materials: [
    ...
    { id: 'MAT003', title: 'Hifz Revision Schedule – Week 12', course: 'Hifz-ul-Quran',  type: 'PDF',  size: '0.5 MB', date: '08 Mar 2025', icon: '📅' },
    { id: 'MAT004', title: 'Islamic Studies Test Paper',        course: 'Islamic Studies', type: 'PDF',  size: '0.9 MB', date: '10 Mar 2025', icon: '📝' },
    { id: 'MAT005', title: 'Introduction to Usool-ul-Fiqh',    course: 'Alim Course',     type: 'PDF',  size: '3.1 MB', date: '12 Mar 2025', icon: '📚' },
    { id: 'MAT006', title: 'Tafseer Ibn Kathir – Summary',     course: 'Tafseer',         type: 'PDF',  size: '4.7 MB', date: '14 Mar 2025', icon: '📜' },
  ]
};
